...
# 配置
filenames = ['C:/Users/zhoupenghua/Desktop/convedna.txt',
             'C:/Users/zhoupenghua/Desktop/ldpcdna.txt',
             'C:/Users/zhoupenghua/Desktop/polardna.txt',
             'C:/Users/zhoupenghua/Desktop/bchdna.txt']
...
class LSTMModel(nn.Module):
    ...
    def forward(self, x, lengths):
        ...
        last_outputs = self.dropout(last_outputs)  # Apply dropout before final layer
...
# 保存模型
torch.save(model.state_dict(), 'lstm0.35_model100000.pth')
...
accuracy_data.to_csv('lstm_model0.35_accuracy_data100000.csv', index=False)
...
class_metrics.to_csv('lstm0.35_model_class_metrics100000.csv', index=False)
...
plt.savefig('lstm0.35_model_confusion_matrix100000.png')
plt.show()
